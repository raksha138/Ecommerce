                ...
                <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
                    ...
                    <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
                        <div className="lg:col-span-2 ">
                            <h1 className="text-lg lg:text-xl font-semibold text-gray-900">Unioutfil</h1>
                            <h1 className='text-lg lg:text-xl text-gray-900 opacity-60 pt-1'>Puff Sleeve Top</h1>
                        </div>
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className="mt-6">
                                <div className='flex items-center space-x-3'>
                                    ...
                                    <p className='opacity-50 text-sm'>64656 Ratings</p>
                                    <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500 ' >3355 Reviews</p>
                                </div>
                         ...
                         <Button variant='contained' sx={{p:"2rem",py:"1rem", bgcolor:"#9155fd"}}>
                            Add to Cart
                         </Button>
                            </form>
                        </div>
                ...
                <Grid container spacing={7}>
                  ...
                  <Grid item xs={5}>
                    ...
                    <div className='flex items-center space-x-3'>
                        ...
                        <p className='opacity-60'>5345345 Ratings</p>
                    </div>
                    ...
                    <Box className='mt-5 space-y-3'>
                        ...
                        <Grid container  alignItems="center" gap={2}>
                            ...
                            <Grid item xs={7}>
                                <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4, height:7}} variant='determinate' value={35} color='secondary'/>
                        ...
                        <Grid container  alignItems="center" gap={2}>
                            ...
                            <Grid item xs={7}>
                                <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4, height:7}} variant='determinate' value={30} color='primary'/>
